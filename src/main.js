...
function initNav() {
  ...
  window.addEventListener('scroll', () => {
    ...
    // Show WhatsApp button after 300px
    if (waBtn) waBtn.classList.toggle('wa-visible', window.scrollY > 300);
  }, { passive: true });
...
function initWAButton() {
  ...
  wa.id        = 'wa-float';
  wa.href      = 'https://wa.me/31653829897?text=Hi%20BECOME%2C%20I%27d%20like%20to%20know%20more';
  wa.target    = '_blank';
  wa.rel       = 'noopener noreferrer';
  wa.setAttribute('aria-label', 'Chat with BECOME on WhatsApp');
  wa.innerHTML = `
